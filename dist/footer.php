      ...
      <footer class="ftr container">
        <a href="<?php echo $site_url ?>" class="ftr__logo">
          <img src="<?php echo $logo_url ?>" alt="Логотип Manifest Magazine" class="ftr__logo-img">
        </a>
        <div class="ftr__inner">
          ...
          $ftr_menu_links = get_field( 'links', wp_get_nav_menu_object( 15 ) ) ?>
          <nav class="ftr__nav">
